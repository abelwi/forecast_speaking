  ...
  <div class="collapse-content mt-5">
    <div class="max-w-4xl mx-auto p-6 bg-white shadow-lg rounded-lg">
      ...
      <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        <div
          class="border-2 border-secondary-content p-4 rounded-lg shadow-md text-center"
        >
          ...
          <p class="text-sm text-gray-600">
            Dự đoán các chủ đề có thể xuất hiện trong bài thi Speaking để chuẩn
            bị tốt hơn.
          </p>
        </div>
        ...
        >
          ...
          <p class="text-sm text-gray-600">
            Giúp bạn học từ vựng và cấu trúc ngữ pháp phù hợp với các chủ đề
            thường gặp.
          </p>
        </div>
        ...
        >
          ...
          <p class="text-sm text-gray-600">
            Cung cấp cách xây dựng ý tưởng và trả lời mẫu để dễ dàng tham gia
            vào các phần của bài thi.
          </p>
        </div>
        ...
        >
          ...
          <p class="text-sm text-gray-600">
            Giúp bạn tự tin hơn khi tham gia phần Speaking của kỳ thi IELTS.
          </p>
        </div>
      </div>
    </div>
      ...
      <div class="space-y-8">
        ...
        <div class="flex items-center space-x-5 sm:space-x-6">
          ...
          <div class="w-2/3">
            ...
            <p class="text-sm text-gray-600">
              Thời gian: 4-5 phút. Câu hỏi về các chủ đề quen thuộc (ví dụ: sở
              thích, quê hương).
            </p>
          </div>
        </div>
        ...
        <div class="flex justify-center">
          <img src="/images/down-arrow.png" alt="Down arrow" class="w-5 h-5" />
        </div>
        ...
        <div class="flex items-center space-x-5 sm:space-x-6">
          ...
          <div class="w-2/3">
            ...
            <p class="text-sm text-gray-600">
              ...
              hơn liên quan đến chủ đề ở Part 2.
            </p>
          </div>
        </div>
      </div>
