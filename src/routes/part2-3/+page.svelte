...
<div class="my-10 mx-20">
  ...
  <div class="sticky top-0 bg-white">
    <div class="flex">
      ...
      <div
        class="flex justify-center w-1/2 overflow-x-auto whitespace-nowrap space-x-16 border-2 border-gray-200 py-3 mt-3 rounded-lg"
      >
    ...
    <div
      class="flex overflow-x-auto whitespace-nowrap border-b-2 border-gray-200 text-lg font-semibold mt-8 pb-3"
    >
  ...
  {#each part23Forecast as topic, i}
    ...
    {#each topic.titles as item, i}
      ...
      <div class="flex items-center space-x-10">
        <div class="w-1/2">
          <div
            class="flex items-center space-x-7 bg-primary-content text-lg text-center px-5 py-4 rounded-lg"
          >
            <img src="/images/describe.png" alt="Describe" class="w-16 h-16" />
        ...
        <div class="w-1/2 mt-5">
          {#each item.questions as question}
            <p
              class="flex space-x-5 border border-primary-content px-4 py-2 rounded-lg mb-5"
            >
